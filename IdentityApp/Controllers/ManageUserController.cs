using IdentityApp.ViewModels.ManageUser;
using IdentityApp.Views.ManageUser;
...
namespace IdentityApp.Controllers
{
    public class ManageUserController : Controller
    {
        ...
        public async Task<IActionResult> AddUserToRole(AddUserToRoleViewModel model)
        {
            ...
            var requestRoles = model.UserRoles.Where(x=>x.IsSelected).Select(x=>x.RoleName).ToList();
